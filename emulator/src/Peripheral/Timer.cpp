...
namespace casioemu {
    void Timer::Initialise() {
        ...
        region_interval.Setup(
            0xF020, 2, "Timer/Interval", &data_interval, MMURegion::DefaultRead<uint16_t>, [](MMURegion *region, size_t offset, uint8_t data) {
        ...
        region_counter.Setup(
            0xF022, 2, "Timer/Counter", &data_counter, MMURegion::DefaultRead<uint16_t>, [](MMURegion *region, size_t, uint8_t) {
