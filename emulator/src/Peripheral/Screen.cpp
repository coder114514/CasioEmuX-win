...
#pragma GCC diagnostic ignored "-Wpedantic" // https://gcc.gnu.org/bugzilla/show_bug.cgi?id=61491
    ...
    template <>
    enum Screen<HW_CLASSWIZ>::Sprite : unsigned {
        SPR_PIXEL,
        SPR_S,
        SPR_A,
        SPR_M,
    ...
    template <>
    enum Screen<HW_ES_PLUS>::Sprite : unsigned {
        SPR_PIXEL,
        SPR_S,
        SPR_A,
        SPR_M,
...
#pragma GCC diagnostic pop
    ...
    template <>
    const SpriteBitmap Screen<HW_CLASSWIZ>::sprite_bitmap[SPR_MAX] = {
        {"rsd_pixel", 0, 0},
        {"rsd_s", 0x01, 0x00},
        {"rsd_a", 0x01, 0x01},
        {"rsd_m", 0x01, 0x02},
    ...
    template <>
    const SpriteBitmap Screen<HW_ES_PLUS>::sprite_bitmap[SPR_MAX] = {
        {"rsd_pixel", 0, 0},
        {"rsd_s", 0x10, 0x00},
        {"rsd_a", 0x04, 0x00},
        {"rsd_m", 0x10, 0x01},
