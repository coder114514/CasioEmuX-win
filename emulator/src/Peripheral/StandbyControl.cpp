...
namespace casioemu {
    void StandbyControl::Initialise() {
        region_stpacp.Setup(
            0xF008, 1, "StandbyControl/STPACP", this, MMURegion::IgnoreRead<0>, [](MMURegion *region, size_t, uint8_t data) {
        ...
        region_sbycon.Setup(
            0xF009, 1, "StandbyControl/SBYCON", this, MMURegion::IgnoreRead<0>, [](MMURegion *region, size_t, uint8_t data) {
                StandbyControl *self = (StandbyControl *)(region->userdata);
                if (data & 0x01) {
